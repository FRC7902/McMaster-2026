...
public class AutoConstants {
    ...
    public static Map<Position, Pose2d> positionToPose = Map.ofEntries(
            ...
            Map.entry(Position.RED_STARTING_LINE_LEFT, PoseUtils.flipAlliance( new Pose2d(4.0218614, 0.632, new Rotation2d(0)))),
            Map.entry(Position.RED_NEUTRAL_LEFT_1, PoseUtils.flipAlliance(new Pose2d(8.02169132232666, 0.632, new Rotation2d(-1.3203533077139966)))),
            Map.entry(Position.RED_NEUTRAL_LEFT_2, PoseUtils.flipAlliance(new Pose2d(7.77288293838501, 3.4187989234924316, new Rotation2d(-1.3203533077139966)))),
            Map.entry(Position.RED_NEUTRAL_LEFT_3, PoseUtils.flipAlliance(new Pose2d(5.869497776031494, 0.632, new Rotation2d(Degrees.of(90))))),
            Map.entry(Position.RED_ALLIANCE_LEFT_1, PoseUtils.flipAlliance(new Pose2d(4.015, 0.632, new Rotation2d(Degrees.of(80.25))))));
}
