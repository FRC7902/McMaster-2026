...
public class RobotContainer {
        ...
        private void configureBindings() {
                ...
                m_driverController.button(2).whileTrue(driveFieldOrientedAutoAim);
                ...
                m_driverController.button(1)
                                .and(m_driverController.button(2).negate())
                ...
                m_driverController.L2()
                                ...
                                .onFalse(
                                                m_indexerSubsystem.stop()
                                                                .unless(m_driverController.button(2)::getAsBoolean));

                m_driverController.L1()
                                .and(m_driverController.button(2).negate()) // Not shooting
